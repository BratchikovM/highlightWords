                 ...
                 t = Math.abs(t - 360);
                   t = (t == 360)? 0 : t;
                     ...
                     Line.Hue = t;
                       ...
                       document.getElementById("out_color").style.backgroundColor= "rgb("+convert.hsv_rgb(t,picker.S,picker.V)+")";
	}
		...
		Block.cPos = function (e){
			...
			picker.S = S;
			  ...
			  picker.V = V;
			     ...
			     document.getElementById('out_color').style.backgroundColor = "rgb("+convert.hsv_rgb(Line.Hue,S,V)+")";
